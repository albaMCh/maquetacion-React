...
const AlumnDetailCard = (props) => {
  ...
  return (
    <div>
      <div className="card">
        <div id="principal">
          <img id="user-image" alt="Avatar" src={images} align="left" />
          <div id="user-info">
            <h2>Marta Fernandez Lopez</h2>
            <h3 id="location">
          ...
          <form>
            <div className="block">
              ...
              <input
                ...
                name="full_name"
                id="full-name"
                placeholder="Marta Fernandez Lopez"
              />
            </div>
            <div className="block">
